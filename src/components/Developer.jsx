...
const Developer = ({animationName = 'victory', ...props}) => {
  ...
  // const { animations: idleAnimation } = useFBX('/models/human/salute.fbx');
  ...
  const {action} = useAnimations(victoryAnimation, group)

  useEffect(() => {
    action[animationName].reset().fadeIn(0.5).play();
    return () => action[animationName].fadeOut(0.5);
  }, [animationName]);
